...
//   };
  ...
  it('calls handleClickYes when clicking the Yes button', () => {
  ...
  it('calls handleClickUpdate when clicking the No update now button', () => {
    // const handleCancel = sinon.spy();
    // wrapper.setProps({handleCancel});
    // expect(handleCancel).not.to.have.been.called;
    // cancelButton(wrapper).simulate('click');
  ...
  it('calls handleClickSave when clicking the save button', () => {
    // const handleCancel = sinon.spy();
    // wrapper.setProps({handleCancel});
    // expect(handleCancel).not.to.have.been.called;
    // cancelButton(wrapper).simulate('click');
