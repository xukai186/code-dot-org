...
class AzureContentModeratorTest < Minitest::Test
  ...
  def setup
    ...
    CDO.stubs(:azure_content_moderation_endpoint).returns('https://region.api.cognitive.microsoft.com/contentmoderator')
    CDO.stubs(:azure_content_moderation_key).returns('fake_azure_api_key')
